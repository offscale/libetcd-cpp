...
Lease::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_LeaseTimeToLive_(Lease_method_names[3], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_LeaseLeases_(Lease_method_names[4], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Lease::Stub::LeaseTimeToLive(::grpc::ClientContext* context, const ::etcdserverpb::LeaseTimeToLiveRequest& request, ::etcdserverpb::LeaseTimeToLiveResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_LeaseTimeToLive_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::etcdserverpb::LeaseTimeToLiveResponse>* Lease::Stub::AsyncLeaseTimeToLiveRaw(::grpc::ClientContext* context, const ::etcdserverpb::LeaseTimeToLiveRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::etcdserverpb::LeaseTimeToLiveResponse>(channel_.get(), cq, rpcmethod_LeaseTimeToLive_, context, request);
}
...
::grpc::Status Lease::Stub::LeaseLeases(::grpc::ClientContext* context, const ::etcdserverpb::LeaseLeasesRequest& request, ::etcdserverpb::LeaseLeasesResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_LeaseLeases_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::etcdserverpb::LeaseLeasesResponse>* Lease::Stub::AsyncLeaseLeasesRaw(::grpc::ClientContext* context, const ::etcdserverpb::LeaseLeasesRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::etcdserverpb::LeaseLeasesResponse>(channel_.get(), cq, rpcmethod_LeaseLeases_, context, request);
}
...
Lease::Service::Service() {
  ...
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Lease::Service, ::etcdserverpb::LeaseTimeToLiveRequest, ::etcdserverpb::LeaseTimeToLiveResponse>(
          std::mem_fn(&Lease::Service::LeaseTimeToLive), this)));
  AddMethod(new ::grpc::RpcServiceMethod(
      Lease_method_names[4],
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Lease::Service, ::etcdserverpb::LeaseLeasesRequest, ::etcdserverpb::LeaseLeasesResponse>(
...
Maintenance::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_HashKV_(Maintenance_method_names[4], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Snapshot_(Maintenance_method_names[5], ::grpc::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_MoveLeader_(Maintenance_method_names[6], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Maintenance::Stub::HashKV(::grpc::ClientContext* context, const ::etcdserverpb::HashKVRequest& request, ::etcdserverpb::HashKVResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_HashKV_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::etcdserverpb::HashKVResponse>* Maintenance::Stub::AsyncHashKVRaw(::grpc::ClientContext* context, const ::etcdserverpb::HashKVRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::etcdserverpb::HashKVResponse>(channel_.get(), cq, rpcmethod_HashKV_, context, request);
}
...
::grpc::Status Maintenance::Stub::MoveLeader(::grpc::ClientContext* context, const ::etcdserverpb::MoveLeaderRequest& request, ::etcdserverpb::MoveLeaderResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_MoveLeader_, context, request, response);
}
...
::grpc::ClientAsyncResponseReader< ::etcdserverpb::MoveLeaderResponse>* Maintenance::Stub::AsyncMoveLeaderRaw(::grpc::ClientContext* context, const ::etcdserverpb::MoveLeaderRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::etcdserverpb::MoveLeaderResponse>(channel_.get(), cq, rpcmethod_MoveLeader_, context, request);
}
...
Maintenance::Service::Service() {
  ...
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Maintenance::Service, ::etcdserverpb::HashKVRequest, ::etcdserverpb::HashKVResponse>(
  ...
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      ::grpc::RpcMethod::NORMAL_RPC,
      new ::grpc::RpcMethodHandler< Maintenance::Service, ::etcdserverpb::MoveLeaderRequest, ::etcdserverpb::MoveLeaderResponse>(
